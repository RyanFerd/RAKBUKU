...
const Cart = () => {
  ...
  useEffect(() => {
    if (Cart && Cart.length > 0) {
      // Pastikan price adalah number dan lakukan perhitungan yang benar
      ...
      {Cart && Cart.length === 0 && (
        <div className="h-screen">
          <div className="h-[100%] flex items-center justify-center flex-col">
            <h1 className="text-5xl lg:text-6xl font-semibold text-zinc-400 mb-2">
              Empty Cart
            </h1>
            <img
              src="/empty-cart.png"
              alt="empty cart"
              className="lg:h-[43vh] mt-4"
            />
          </div>
        </div>
      )}
